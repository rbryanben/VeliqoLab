...
class CustomPasswordEditText : FrameLayout {
    ...
    private fun init(context: Context,attrs: AttributeSet?) {
        ...
        // Inflate a view
        LayoutInflater.from(context).inflate(R.layout.custom_password_edit_text,this,true)

        // Set variables
        headerTextView = rootView.findViewById(R.id.customPasswordEditTextHintTextView)
        editText = rootView.findViewById(R.id.customPasswordEditTextEditText)
