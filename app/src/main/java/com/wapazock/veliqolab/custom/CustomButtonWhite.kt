...
class CustomButtonWhite : FrameLayout {
    ...
    // Enable Button
    public fun enable(){
        buttonRelativeLayout.setBackgroundResource(R.drawable.background_custom_button_white_enabled)
    }

    // Disable Button
    public fun disable(){
        buttonRelativeLayout.setBackgroundResource(R.drawable.background_custom_button_white_disabled)
    }
    ...
    private fun init(context: Context, attr: AttributeSet?){
        // Inflate a layout
        LayoutInflater.from(context).inflate(R.layout.custom_button_white,this,true);
